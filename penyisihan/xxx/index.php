...
<html>
	...
	<!-- definisikan judul -->
	<title>	GENIUS 2016 | BUAT KUNCI</title>
	...
	<div class="tiket">
		...
		<div>
			<div>
				...
				$query2 = "SELECT indeks FROM tbkunci";
				...
				<!-- EDITOR SOAL -->
	      		<h2>KUNCI</h2>
	      		<input id="contenteditor" name="content" id="content" rows="12" />
