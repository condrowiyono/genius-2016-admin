...
?>
    ...
    <div class="table-responsive">
  	...
  	<thead>
		<tr>
			<th>Nama Tim</th><th>Sekolah</th><th>Mulai</th><th>Selesai</th><th>Sisa Waktu</th><th>Status</th><th>Hapus</th>
		</tr>
	</thead>
	<tbody>
    	<?php
        	  	...
        	  	<tr>
			      	...
			      	<td><?php echo $row['sekolah'] ?></a></td>
	             		...
	             		<td><?php echo $row['sudah'] ?></a></td>
	              		<td><a onClick="return confirm('Anda yakin akan menghapus?')" href="penyisihanhapus.php?email=<?php echo $row['email'] ?>">Hapus</a></td>	
			</tr>
        <?php
		}
	?> 
